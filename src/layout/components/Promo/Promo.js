...
Вместе с нашим приложением!
              ...
              <div className="main_page_text">
                Наше приложение — эффективный сервис увлекательной практики языка. Уже более 2-х человек (в смысле пока только мы - разработчики)во всем мире уже с
                нами. Присоединяйся!
              </div>
            </Col>
            <Col lg={7}>
          ...
          <div className="text_after_title">Плюшки, которые вы найдете в нашем приложении для себя и своих близких</div>
          <Container fluid>
            <Row>
              <Col xs={12} md={6}>
                <FeatureCard
              ...
              <Col xs={12} md={6}>
                <FeatureCard
                  ...
                  text={
                    ...
                    + ' изученным'
                    + ' словам обновли всегда доступна в'
                    + ' настройках.'
                  }
          ...
          <div className="text_after_title">Английский не обязательно "зубрить". Гораздо приятнее - по-настоящему наслаждаться процессом при этом знания будут приобретаться сами собой.</div>
          <div className="wrapper_game">
            ...
            />
            <GameCard src="./assets/images/promo/game_5.svg" title="Аудиовызов" text="Улучшается восприятие разговорной речи на слух. " />
          </div>
          ...
          <div className="wrapper_game">
            <GameCard
              ...
              title="Спринт"
              text={
                'Учимся скоростному переводу с английского на ваш '
            ...
            <GameCard
              ...
              title="Саванна"
              text={'Практикуемся в понимание английской речи и быстром ' + 'переводе слов, не забываем про выученные слова. '}
            />

            <GameCard
              src="./assets/images/promo/game_6.svg"
              title="Мемори"
              text={'Запоминаем значение слов и учимся качественно ' + 'формулировать свои мысли на английском.'}
            />
          </div>
          <div id="method" />
          <h2 className="promo_title_mid">Метод интервальных повторений</h2>
          <div className="text_after_title">
                        Метод интервальных повторений поможет надолго запомнить новый материал. Преимущество метода заключается в том, что информацию,
          ...
          <img className="full_width" src="./assets/images/promo/graph.svg" alt="green graph waved" width="100px" />
          <div className="text_after_title">
                        Всё что Вам нужно - это лишь регулярно
                        тренироваться.
                        Программное обеспечение на основе метода интервальных повторений всё сделает за вас. При необходимости продолжительность интервалов можно регулировать в настройках.
          </div>
          <IntervalInfo />
          <Study />
        </div>
